...
export default function Marquee() {
  const items = (
    <div className="flex items-center gap-8 px-4">
      ...
      <span className="text-tertiary-container font-black text-[36px] sm:text-[48px] md:text-[60px] uppercase">Taptaze Meyveler</span>
      ...
      <span className="text-strawberry-pop font-black text-[36px] sm:text-[48px] md:text-[60px] uppercase">Sınırsız Topping</span>
      <span className="material-symbols-outlined text-honey-glaze text-[80px] sm:text-[110px] md:text-[140px] icon-fill">star</span>
      <span className="text-honey-glaze font-black text-[36px] sm:text-[48px] md:text-[60px] uppercase">Günlük Taze Hamur</span>
