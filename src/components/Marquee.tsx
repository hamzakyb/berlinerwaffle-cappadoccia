...
export default function Marquee() {
  const items = (
    <div className="flex items-center gap-8 px-4">
      ...
      <span className="material-symbols-outlined text-honey-glaze text-[36px] sm:text-[48px] md:text-[60px] icon-fill">star</span>
      ...
      <span className="material-symbols-outlined text-strawberry-pop text-[36px] sm:text-[48px] md:text-[60px] icon-fill">favorite</span>
      <span className="text-white font-black text-[36px] sm:text-[48px] md:text-[60px] uppercase">Mutluluk Kutusu</span>
      <span className="material-symbols-outlined text-tertiary-container text-[36px] sm:text-[48px] md:text-[60px] icon-fill">star</span>
    </div>
  );
