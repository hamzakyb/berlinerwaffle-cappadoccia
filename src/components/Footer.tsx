...
export default function Footer() {
  return (
    <footer className="w-full mt-24 bg-light-pink py-16 border-t-8 border-black relative overflow-hidden select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="font-bold text-xl text-black max-w-xs bg-white p-4 rounded-2xl border-4 border-black sticker-shadow">
        ...
        <div className="flex flex-col gap-4">
          <h4 className="font-black text-2xl text-black uppercase mb-2">
            Sosyal Medya
          </h4>
          <a
            className="font-bold text-xl text-black hover:text-strawberry-pop transition-colors hover:translate-x-2 w-fit flex items-center gap-2"
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            className="font-bold text-xl text-black hover:text-strawberry-pop transition-colors hover:translate-x-2 w-fit"
            href="#"
          >
            Privacy Policy
          </a>
        ...
        {/* Copyright */}
        <div className="col-span-1 md:col-span-3 pt-8 mt-8 border-t-4 border-black flex justify-between items-center flex-wrap gap-4">
          <p className="font-black text-lg text-black/60 uppercase">
